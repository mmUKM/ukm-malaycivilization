  ...
  <article class="padding column">
    ...
    <?php
      $query = new WP_Query( array(
        ...
        'atma_warisan_database' => get_query_var( 'atma_warisan_database' ),
        'posts_per_page'        => -1,
        'order'                 => 'ASC'
      ));
    ?>
    ...
    <?php if( $query->have_posts() ) : while( $query->have_posts() ) : $query->the_post(); ?>
      <li class="column">
        ...
        <div class="large-2-12"><a class="data-content-detail-link" href="<?php echo get_permalink(); ?>"><?php _e( 'Detail', 'atma' ); ?></a></div>
      </li>
      <?php endwhile;else: ?>
