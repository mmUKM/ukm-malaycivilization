...
// main-nav
$('#nav-main').prepend('<div id="menu-button">Menu</div>');
...
( function( $ ) {
$( document ).ready(function() {
$('#nav-database li.has-sub>a').on('click', function(){
	...
	$('#nav-database>ul>li.has-sub>a').append('<span class="holder"></span>');

	(function getColor() {
		var r, g, b;
		var textColor = $('#nav-database').css('color');
